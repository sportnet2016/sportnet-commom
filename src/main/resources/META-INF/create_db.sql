...
ID_VENDA BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1) CONSTRAINT PK_VENDA PRIMARY KEY,
ID_CLIENTE BIGINT NOT NULL,
DT_VENDA TIMESTAMP NOT NULL,
VL_TOTAL DOUBLE NOT NULL

);
ALTER TABLE TB_VENDA ADD CONSTRAINT FK_VENDA_CLIENTE FOREIGN KEY (ID_CLIENTE) REFERENCES USUARIO_CLIENTE(ID_CLIENTE);
